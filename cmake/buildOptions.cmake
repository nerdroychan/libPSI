...
# here we have to do some special logic to determine if we should automaticly download sparsehash. This is done if we
# used
#
# does not define FETCH_SPARSEHASH and define FETCH_AUTO or define FETCH_SPARSEHASH as True/ON
set_bool(
  FETCH_SPARSEHASH_AUTO
  (DEFINED FETCH_SPARSEHASH AND FETCH_SPARSEHASH)
  OR
...
# used
#
# does not define FETCH_LIBOTE and define FETCH_AUTO or define FETCH_LIBOTE as True/ON
set_bool(
  FETCH_LIBOTE_AUTO
  (DEFINED FETCH_LIBOTE AND FETCH_LIBOTE)
  OR
