...
#else
  std::cout << Color::Red << "RR17 PSI is not enabled" << std::endl
            << Color::Default;
#endif
}
...
#else
  std::cout << Color::Red << "RR17B PSI is not enabled" << std::endl
            << Color::Default;
#endif
}
...
#else
  std::cout << Color::Red << "KKRT PSI is not enabled" << std::endl
            << Color::Default;
#endif
}
...
#else
  std::cout << Color::Red << "GRR PSI is not enabled" << std::endl
            << Color::Default;
#endif
}
