...
public:
  ...
  void getSuperBlksCoefficients(u64 degree, std::vector<block> &setX, std::vector<std::array<block, numSuperBlocks>> &setY, std::vector<std::array<block, numSuperBlocks>> &coeffs);
  ...
  void evalSuperPolynomial(std::vector<std::array<block, numSuperBlocks>> &coeffs, std::vector<block> &setX, std::vector<std::array<block, numSuperBlocks>> &setY);
};
