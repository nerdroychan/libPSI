...
void polyNTL::getSuperBlksCoefficients(u64 degree, std::vector<block> &setX, std::vector<std::array<block, numSuperBlocks>> &setY, std::vector<std::array<block, numSuperBlocks>> &coeffs)
{
  // degree = setX.size() - 1;
  NTL::vec_GF2E x;
  NTL::vec_GF2E y;
...
void polyNTL::evalSuperPolynomial(std::vector<std::array<block, numSuperBlocks>> &coeffs, std::vector<block> &setX, std::vector<std::array<block, numSuperBlocks>> &setY)
{
  NTL::GF2EX res_polynomial;
  NTL::GF2E e;
  // std::cout << coeffs.size() << std::endl;
