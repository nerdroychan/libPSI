...
public:
  ...
  void init(u64 n, u64 statSecParam, Channel &chl0, OosNcoOtReceiver &otRecv, OosNcoOtSender &otSend, block seed, double binScaler = 4.0, u64 inputBitSize = -1);
  void init(u64 n, u64 statSecParam, span<Channel> chls, OosNcoOtReceiver &ots, OosNcoOtSender &otSend, block seed, double binScaler = 4.0, u64 inputBitSize = -1);
