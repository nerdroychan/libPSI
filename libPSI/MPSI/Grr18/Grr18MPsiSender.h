...
public:
  ...
  void init(u64 n, u64 statSecParam, span<Channel> chls, OosNcoOtSender &ots, OosNcoOtReceiver &otRecv, block seed, double binScaler = 4.0, u64 inputBitSize = -1);

  void init(u64 n, u64 statSecParam, Channel &chl0, OosNcoOtSender &ots, OosNcoOtReceiver &otRecv, block seed, double binScaler = 4.0, u64 inputBitSize = -1);
