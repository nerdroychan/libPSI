...
void Grr18MPsiSender::init(u64 n, u64 statSec, Channel &chl0, OosNcoOtSender &ots, OosNcoOtReceiver &otRecv, block seed, double binScaler, u64 inputBitSize)
{
  std::vector<Channel> c{ chl0 };
  init(n, statSec, c, ots, otRecv, seed, binScaler, inputBitSize);
}

void Grr18MPsiSender::init(u64 n, u64 statSecParam, span<Channel> chls, OosNcoOtSender &otSend, OosNcoOtReceiver &otRecv, block seed, double binScaler, u64 inputBitSize)
{
