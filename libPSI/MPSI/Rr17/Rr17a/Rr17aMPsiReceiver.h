...
public:
  ...
  void init(u64 n, u64 statSecParam, Channel &chl0, NcoOtExtReceiver &otRecv, NcoOtExtSender &otSend, block seed, double binScaler = 1.0, u64 inputBitSize = -1);
  void init(u64 n, u64 statSecParam, span<Channel> chls, NcoOtExtReceiver &ots, NcoOtExtSender &otSend, block seed, double binScaler = 1.0, u64 inputBitSize = -1);
