...
public:
  ...
  void init(u64 n, u64 statSecParam, span<Channel> chls, NcoOtExtSender &ots, NcoOtExtReceiver &otRecv, block seed, double binScaler = 1.0, u64 inputBitSize = -1);

  void init(u64 n, u64 statSecParam, Channel &chl0, NcoOtExtSender &ots, NcoOtExtReceiver &otRecv, block seed, double binScaler = 1.0, u64 inputBitSize = -1);
