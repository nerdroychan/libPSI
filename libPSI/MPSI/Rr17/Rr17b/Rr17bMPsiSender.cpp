...
void Rr17bMPsiSender::init(u64 n, u64 statSec, Channel &chl0, NcoOtExtSender &ots, block seed, double binScaler, u64 inputBitSize)
{
  init(n, statSec, { &chl0, 1 }, ots, seed, binScaler, inputBitSize);
}

void Rr17bMPsiSender::init(u64 n, u64 statSecParam, span<Channel> chls, NcoOtExtSender &otSend, block seed, double binScaler, u64 inputBitSize)
{
